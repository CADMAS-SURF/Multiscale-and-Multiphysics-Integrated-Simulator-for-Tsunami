      SUBROUTINE VF_BWFFSF(ZZ,FF,DMTBTT,DMTBHH,DBUF,NF,INDX,INDY,INDB)
...
CD    INDB(MAXB1,NUMB) : IN  : I*4 : 境界面のインデックス
      ...
      DIMENSION FF  (NUMI,NUMJ,NUMK),DMTBTT(MTBTT),DMTBHH(MTBTT)
                ...
                DO 110 K=2,NUMK-1
                  ...
                  DO 100 J=IBCTYP(3,JD),IBCTYP(4,JD)
                    IF (MYGJS.LE.J .AND. J.LE.MYGJE) THEN
                      IF (NF(IC-IP,J-JP,K).GT.-1) FF(IC-IP,J-JP,K)=VAL
                    ENDIF
 100              CONTINUE
 110            CONTINUE
              ENDIF
                ...
                DO 210 K=2,NUMK-1
                  ...
                  DO 200 I=IBCTYP(3,JD),IBCTYP(4,JD)
                    IF (MYGIS.LE.I .AND. I.LE.MYGIE) THEN
                      IF (NF(I-IP,JC-JP,K).GT.-1) FF(I-IP,JC-JP,K)=VAL
                    ENDIF
 200              CONTINUE
 210            CONTINUE
              ENDIF
