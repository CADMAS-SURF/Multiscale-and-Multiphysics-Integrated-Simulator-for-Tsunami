          ...
          DO 100 I=MYIS,MYIE+1
            IF (INDX(I,J,K).GT.-1) THEN
              ...
              IF (N.GT.-1) THEN
                FD=FF(LD,J,K)
                FDMW=1.0D0
                IF (NF(LDM,J,K).GT.-1) FDMW=FF(LDM,J,K)
          ...
          DO 200 I=MYIS,MYIE
            IF (INDY(I,J,K).GT.-1) THEN
              ...
              IF (N.GT.-1) THEN
                FD=FF(I,LD,K)
                FDMW=1.0D0
                IF (NF(I,LDM,K).GT.-1) FDMW=FF(I,LDM,K)
          ...
          DO 300 I=MYIS,MYIE
            IF (INDZ(I,J,K).GT.-1) THEN
              ...
              IF (N.GT.-1) THEN
                FD=FF(I,J,LD)
                FDMW=1.0D0
                IF (NF(I,J,LDM).GT.-1) FDMW=FF(I,J,LDM)
