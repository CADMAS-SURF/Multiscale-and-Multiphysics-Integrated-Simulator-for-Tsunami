      SUBROUTINE GNPFLW_S(FLI,FLO,FCP,VELG,VELE,GRID,UG1,UG2,UG3,PG1,PG3
     &                   ,KN,ND,AMAT,GRAV,DT1,DT2,ALP,IDYN,ITO)

      IMPLICIT REAL*8(A-H,O-Z)
      DIMENSION FI(ND),FO(ND),FP(3,ND),VELG(3,*),VELE(3),GRID(3,*)
     &         ,UG1(6,*),UG2(6,*),UG3(6,*),PG1(*),PG3(*),KN(ND),AMAT(*)
     &         ,GRAV(3),X(3,ND),UD(3,ND),UDD(3,ND),P(ND),PB(ND),PD(ND)
     &         ,FLI(*),FLO(*),FCP(3,*)
