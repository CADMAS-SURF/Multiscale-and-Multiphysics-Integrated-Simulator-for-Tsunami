      SUBROUTINE NL_STATIC_S(KK,RR,IFL,FLNAME,NLEN,ICK)
...
C     &               ,IASEWK,IFL(12),IFL(13),0.D0,0,0,0,0,ITO)
     ...
     &             ,KK(28),KK(12))
        ...
        CALL NPFLOW_S(FLI,FLO,FCP,VELG,KK(36),VELE,RHV,KK,RR,GRID,IELM
     &               ,KK(37),AMAT,INDOP,UG1,UG2,UG3,PG1,PG3,DT1,DT2,0,1
     &               ,ITO)
     ...
     &                    ,IELC,UG3,POS,0,ITER2,0)
          ...
          CALL NPFORCE_S(FTI,FCK,FCD,FCM,FCMD,FCP,EPSG,SIGG,KK(36),KK,N4
     &                  ,KK(33),RR,GRID,IELM,KK(37),AMAT,RODA,BARD,BVEC
     &                  ,DMT,UG3,VG,PPND,DT1,DT2,ITER,ITER2,0,ITO)
