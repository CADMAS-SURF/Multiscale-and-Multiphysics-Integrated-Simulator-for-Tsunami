      ...
      IF     (ILPARA(1).EQ.1) THEN
        ...
        DO 120 M=M1,M2
          DO 110 L=1,(N1-1)/MAXELE+1
            ...
            DO 100 I2=N2,1,-1
C-----------------------------------------------------------------------
C             WRITE(ILPFIL,9530) I2-1+I2P,(NF(I1,I2,M),I1=I1S,I1E)
              WRITE(ILPFIL,'(1X,I6,A1$)') I2-1+I2P,' ' 
              DO I1=I1S,I1E
                IF(NF(I1,I2,M)>=0) THEN
                  WRITE(ILPFIL,'(I1$)') NF(I1,I2,M)
                ELSE
                  WRITE(ILPFIL,'(A1$)') '*'
                END IF
              END DO
        ...
        DO 220 M=M1,M2
          IF (MS.LE.M .AND. M.LE.ME) THEN
            DO 210 L=1,(N1-1)/MAXELE+1
              ...
              DO 200 I2=N2,1,-1
C-----------------------------------------------------------------------
C               WRITE(ILPFIL,9530) I2-1,(NF(I1,M-MS+1,I2),I1=I1S,I1E)
                WRITE(ILPFIL,'(1X,I6,A1$)') I2-1,' ' 
                DO I1=I1S,I1E
                  IF(NF(I1,M-MS+1,I2)>=0) THEN
                    WRITE(ILPFIL,'(I1$)') NF(I1,M-MS+1,I2)
                  ELSE
                    WRITE(ILPFIL,'(A1$)') '*'
                  END IF
                END DO
        ...
        DO 320 M=M1,M2
          IF (MS.LE.M .AND. M.LE.ME) THEN
            DO 310 L=1,(N1-1)/MAXELE+1
              ...
              DO 300 I2=N2,1,-1
C-----------------------------------------------------------------------
C               WRITE(ILPFIL,9530) I2-1,(NF(M-MS+1,I1,I2),I1=I1S,I1E)
                WRITE(ILPFIL,'(1X,I6,A1$)') I2-1,' ' 
                DO I1=I1S,I1E
                  IF(NF(M-MS+1,I1,I2)>=0) THEN
                    WRITE(ILPFIL,'(I1$)') NF(M-MS+1,I1,I2)
                  ELSE
                    WRITE(ILPFIL,'(A1$)') '*'
                  END IF
                END DO
      ...
      ELSEIF (ILPARA(1).EQ.4) THEN
        ...
        DO 420 M=M1,M2
          DO 410 L=1,(N1-1)/MAXELE+1
            ...
            DO 400 I2=N2,1,-1
C-----------------------------------------------------------------------
C             WRITE(ILPFIL,9530) I2-1+I2P,(NF(I2,I1,M),I1=I1S,I1E)
              WRITE(ILPFIL,'(1X,I6,A1$)') I2-1+I2P,' ' 
              DO I1=I1S,I1E
                IF(NF(I2,I1,M)>=0) THEN
                  WRITE(ILPFIL,'(I1$)') NF(I2,I1,M)
                ELSE
                  WRITE(ILPFIL,'(A1$)') '*'
                END IF
              END DO
...
C-----------------------------------------------------------------------
C               WRITE(ILPFIL,9530)
C    &                       I2-1+I2P,(NF(I2,M-MS+1,I1),I1=I1S,I1E)
                WRITE(ILPFIL,'(1X,I6,A1$)') I2-1+I2P,' ' 
                DO I1=I1S,I1E
                  IF(NF(I2,M-MS+1,I1)>=0) THEN
                    WRITE(ILPFIL,'(I1$)') NF(I2,M-MS+1,I1)
                  ELSE
                    WRITE(ILPFIL,'(A1$)') '*'
                  END IF
                END DO
...
C-----------------------------------------------------------------------
C               WRITE(ILPFIL,9530)
C    &                       I2-1+I2P,(NF(M-MS+1,I2,I1),I1=I1S,I1E)
                WRITE(ILPFIL,'(1X,I6,A1$)') I2-1+I2P,' ' 
                DO I1=I1S,I1E
                  IF(NF(M-MS+1,I2,I1)>=0) THEN
                    WRITE(ILPFIL,'(I1$)') NF(M-MS+1,I2,I1)
                  ELSE
                    WRITE(ILPFIL,'(A1$)') '*'
                  END IF
                END DO
